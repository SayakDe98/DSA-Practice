...
//     n
//     == matrix.length
//     == matrix[i].length 1 <= n <= 20 - 1000 <= matrix[i][j] <= 1000

//Approach:
//1)Transpose the matrix: swap columns with rows
//2)Swap the columns: reverse the matrix for each row
#include<iostream>
#include<vector>
#include<algorithm>
using namespace std;
